    ...
    <table>
        <tr>
            ...
            <tr>
                <td>印刷文字识别_行驶证识别</td>
                <td>APP</td>
                <td>机动车行驶证是准予机动车在我国境内道路上行驶的法定证件。-行驶证识别可以通过图片识别技术返回行驶证中的信息。</td>
            </tr>
    </table>
</div>
...
## API name: 印刷文字识别_行驶证识别

### *Description*

机动车行驶证是准予机动车在我国境内道路上行驶的法定证件。-行驶证识别可以通过图片识别技术返回行驶证中的信息。

### *Request information*

HTTP protocol: HTTP,HTTPS

Call address: dm-53.data.aliyun.com/rest/160601/ocr/ocr_vehicle.json
