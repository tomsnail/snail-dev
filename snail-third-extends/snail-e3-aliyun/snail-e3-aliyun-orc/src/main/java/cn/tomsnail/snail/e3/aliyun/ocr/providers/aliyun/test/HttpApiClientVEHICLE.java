...
public class HttpApiClientVEHICLE extends ApacheHttpClient implements Post{
    public final static String HOST = "dm-53.data.aliyun.com";
    static HttpApiClientVEHICLE instance = new HttpApiClientVEHICLE();
    public static HttpApiClientVEHICLE getInstance(){return instance;}
