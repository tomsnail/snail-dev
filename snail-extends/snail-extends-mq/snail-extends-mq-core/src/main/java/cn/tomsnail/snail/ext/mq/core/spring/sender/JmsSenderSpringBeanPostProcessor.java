package cn.tomsnail.snail.ext.mq.core.spring.sender;
...
import cn.tomsnail.snail.ext.mq.core.JmsSenderFactory;
import cn.tomsnail.snail.ext.mq.core.spring.annotation.JmsClassd;
import cn.tomsnail.snail.ext.mq.core.spring.annotation.JmsSender;
...
public class JmsSenderSpringBeanPostProcessor implements BeanPostProcessor{
	...
	public Object postProcessBeforeInitialization(Object bean, String beanName)
		...
		if(clazz.isAnnotationPresent(JmsClassd.class)){
			...
			for(Field f:fs){
				if(f.getType().getCanonicalName().startsWith("cn.tomsnail.snail.ext.mq.core.IJmsSender")&&f.isAnnotationPresent(JmsSender.class)){
