...
import cn.tomsnail.snail.core.starter.ISpringService;
import cn.tomsnail.snail.core.starter.SpringServiceManager;
...
public class StarterBeanPostProcessor implements BeanPostProcessor{
	...
	public Object postProcessBeforeInitialization(Object bean, String beanName)
		...
		if(bean.getClass().getTypeName().startsWith("cn.tomsnail.snail.core.starter.domain.SpringServiceManager")){
	...
	public Object postProcessAfterInitialization(Object bean, String beanName)
			throws BeansException {
			if(!bean.getClass().getTypeName().equals("cn.tomsnail.snail.core.starter.domain.SpringServiceManager")){
				Class[] classes = bean.getClass().getInterfaces();
				if(classes!=null&&classes.length>0){
					for(Class clazz:classes){
						if(clazz.getTypeName().equals("cn.tomsnail.snail.core.starter.domain.ISpringService")){
