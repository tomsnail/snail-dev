...
import cn.tomsnail.core.util.validator.handler.BizValidator;
...
public class ValidatorFactory{
	...
	public static HibernateObjectValidator getHibernateObjectValidator(){return  new HibernateObjectValidator();};
