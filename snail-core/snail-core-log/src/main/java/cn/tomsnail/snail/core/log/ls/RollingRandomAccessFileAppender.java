...
public class RollingRandomAccessFileAppender extends  AbstractOutputStreamAppender<RollingRandomAccessFileManager>{
	 ...
	 private final String fileName;
	    ...
	    private RollingRandomAccessFileAppender(final String name, final Layout<? extends Serializable> layout,
	            ...
	            final boolean immediateFlush, final int bufferSize, final Advertiser advertiser,int intLevel) {
	    ...
	    public static RollingRandomAccessFileAppender createAppender(
	        ...
	        final int intLevel = Integers.parseInt(level, 500);
	        ...
	        return new RollingRandomAccessFileAppender(name, layout, filter, manager,
	                ...
	                isAdvertise ? config.getAdvertiser() : null,intLevel);
	    }
