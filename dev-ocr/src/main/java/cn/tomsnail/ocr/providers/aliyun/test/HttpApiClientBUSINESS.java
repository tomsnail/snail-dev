...
public class HttpApiClientBUSINESS extends ApacheHttpClient implements Post{
    public final static String HOST = "dm-58.data.aliyun.com";
    static HttpApiClientBUSINESS instance = new HttpApiClientBUSINESS();
    public static HttpApiClientBUSINESS getInstance(){return instance;}
