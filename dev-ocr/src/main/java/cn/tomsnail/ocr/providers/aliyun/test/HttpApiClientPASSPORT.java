...
public class HttpApiClientPASSPORT extends ApacheHttpClient implements Post{
    public final static String HOST = "ocrhz.market.alicloudapi.com";
    static HttpApiClientPASSPORT instance = new HttpApiClientPASSPORT();
    public static HttpApiClientPASSPORT getInstance(){return instance;}
