...
public class HttpsApiClientBANKCARD extends ApacheHttpClient implements Post{
    public final static String HOST = "yhk.market.alicloudapi.com";
    static HttpsApiClientBANKCARD instance = new HttpsApiClientBANKCARD();
    public static HttpsApiClientBANKCARD getInstance(){return instance;}
