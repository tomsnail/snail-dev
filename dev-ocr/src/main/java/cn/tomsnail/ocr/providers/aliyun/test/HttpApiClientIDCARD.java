...
public class HttpApiClientIDCARD extends ApacheHttpClient implements Post{
    public final static String HOST = "dm-51.data.aliyun.com";
    static HttpApiClientIDCARD instance = new HttpApiClientIDCARD();
    public static HttpApiClientIDCARD getInstance(){return instance;}
