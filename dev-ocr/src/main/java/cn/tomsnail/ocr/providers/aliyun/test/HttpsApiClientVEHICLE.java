...
public class HttpsApiClientVEHICLE extends ApacheHttpClient implements Post{
    public final static String HOST = "dm-53.data.aliyun.com";
    static HttpsApiClientVEHICLE instance = new HttpsApiClientVEHICLE();
    public static HttpsApiClientVEHICLE getInstance(){return instance;}
