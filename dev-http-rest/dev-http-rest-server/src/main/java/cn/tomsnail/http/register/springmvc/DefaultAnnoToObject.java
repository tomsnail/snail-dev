...
import cn.tomsnail.http.register.annotation.HttpRestGet;
import cn.tomsnail.http.register.annotation.HttpRestPost;
...
public class DefaultAnnoToObject implements IAnnoToObject {
	...
	@Override
	public void getObjectFromAnno(
			Map.Entry<RequestMappingInfo, HandlerMethod> m, IRegister register,
			Address address) {
