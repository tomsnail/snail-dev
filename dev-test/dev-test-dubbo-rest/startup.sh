...
EXE_NAME=npc-bc-basic-enterprise-dubbo
...
$JAVA_HOME/bin/java -Djava.security.egd=file:/dev/./urandom -D$EXE_NAME $MEM_OPTS  -classpath $cp cn.tomsnail.starter.domain.AppMain &
