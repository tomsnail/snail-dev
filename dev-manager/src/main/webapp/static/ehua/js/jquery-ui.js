...
function Datepicker() {
	...
	this.regional = []; // Available regional settings, indexed by la	nguage code
	this.regional[ "" ] = { // Default regional settings
		closeText: "关闭",//Done", // Display text for close link
        ...
        '七','八','九','十','十一','十二'],  // [ "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" ], // For formatting
		dayNames: ['星期日','星期一','星期二','星期三','星期四','星期五','星期六'], //[ "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday" ], // For formatting
		dayNamesShort:  ['周日','周一','周二','周三','周四','周五','周六'],  //[ "Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat" ], // For formatting
		dayNamesMin:  ['日','一','二','三','四','五','六'], //[ "Su","Mo","Tu","We","Th","Fr","Sa" ], // Column headings for days starting at Sunday
		weekHeader: "周",//"Wk", // Column header for week of the year
